...
function Testimonials() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Natalia",
      review:
        "Face powder sets the foundation and under eye concealer, giving it a matte finish while also concealing small flaws or blemishes. It can also be used to bake the foundation, so that it stays on longer and create a matte finish. Highly worth a visit !",
    },
  ];
  return (
    <Section ref={element}>
